...
BEGIN 
	INSERT INTO USUARIOS_MIKAY (ID_USER, NOMBRE, EMAIL, TELEFONO, ROL, PASSWORD)
	VALUES (ID_USER_C, NOMBRE_C, EMAIL_C, TELEFONO_C, ROL_C, PASSWORD_C);
	COMMIT;
END
...
BEGIN 
	UPDATE USUARIOS_MIKAY 
	SET NOMBRE = NOMBRE_C, EMAIL = EMAIL_C, TELEFONO = TELEFONO_C, ROL = ROL_C, PASSWORD = PASSWORD_C
	WHERE ID_USER = ID_USER_C;
END
$$
DELIMITER ;
...
BEGIN 
	DELETE FROM USUARIOS_MIKAY WHERE ID_USER = ID_USER_C;
	COMMIT;
END
$$
DELIMITER ;
