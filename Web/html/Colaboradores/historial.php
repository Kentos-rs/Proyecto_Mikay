...
<body class="bg-danger bg-opacity-25">
    <div class="sidebar close">
        ...
        <li>
            <a href="/Colaboradores/pedidos.php">
            <i class='bx bx-collection'></i>
            <span class="link_name">Pedidos</span>
            </a>
            <ul class="sub-menu blank">
            <li><a class="link_name" href="/Colaboradores/pedidos.php">Pedidos</a></li>
            </ul>
        </li>
        <li>
            <div class="iocn-link">
            <a href="/Colaboradores/historial.php">
            ...
            <ul class="sub-menu">
            <li><a class="link_name" href="/Colaboradores/historial.php">Historial</a></li>
    ...
    <section class="home-section">
        ...
        <h3 class="text-dark">Historial</h3>
        </div>
    </section>
