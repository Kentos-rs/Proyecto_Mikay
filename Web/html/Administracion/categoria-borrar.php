                    ...
                    <tbody>
                                ...
                                while($row = mysqli_fetch_array(($resultado))){
                                    if($row['ID_CATEGORIA'] == $_id){?>
                                        <tr>
                                            ...
                                            <form action="/Administracion/categoria-borrar.php" method="post">
                                                <td>
                                                ...
                                                <td>
                                                    <div class="col">
                                                        <button type="submit" name="delete_categoria" class="btn btn-dark bg-warning shadow text-dark">Eliminar</button>
                                                        <input type="number" name="id_delete_categoria" class="invisible form-control " id="floatingInput" value="<?php echo $row['ID_CATEGORIA'];?>">
                                                    </div>
                                                </td>
                                            </form>
                                        </tr><?php    
                        ...
                        <?php 
                            ...
                            if(isset($_POST['delete_categoria'])){
                                $id_delete = $_POST['id_delete_categoria'];
                                $resu = "CALL DELETE_CATEGORIA ($id_delete)";
                                if ($conn->query($resu) === TRUE) {
                                    ?> <h3 class="mt-3 text-center bg-success">Categoria eliminada exitosamente</h3> <?php
                                } else {
