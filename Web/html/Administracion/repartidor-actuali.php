...
<body >
    ...
    <section class="home-section">
        ...
        <h3 class="text-dark">Actualizar Repartidor</h3>
        </div>
        <div class="container">
            <div class="row p-5">
                <div class="col"></div>
                <div class="col text-center">  
                    <form method="get">
                        <h5 class="">Ingrese el identificador del repartidor a actualizar</h5>
                        <div class="form-floating mb-3 mt-2">
                            <input type="number" name="id_act_repartidor" class="form-control" id="floatingInput" placeholder="Identificador">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                        ...
                        if(isset($_GET['buscar_repartidor'])){
                            if($_GET['id_act_repartidor'] !=''){
                                $_id = $_GET['id_act_repartidor'];
                                ...
                                while($row = mysqli_fetch_array(($resultado))){
                                    if($row['ID'] == $_id){?>
                                        <tr>
                                            ...
                                            <form action="/Administracion/repartidor-actuali.php" method="post">
                                                <td>
                                                    <div class="col-md-5">
                                                        <input type="number" name="id_new_repartidor" class="form-control " id="floatingInput" value="<?php echo $row['ID'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <input type="text" name="nombre_new_repartidor" class="form-control " id="floatingInput" value="<?php echo $row['NOMBRE'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <input type="text" name="vehiculo_new_repartidor" class="form-control " id="floatingInput" value="<?php echo $row['VEHICULO'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <input type="text" name="telefono_new_repartidor" class="form-control " id="floatingInput" value="<?php echo $row['TELEFONO'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <button type="submit" name="act_repartidor" class="btn btn-dark bg-warning shadow text-dark">Actualizar</button>
                                                    </div>
                                                </td>
                                            </form>
                                        </tr><?php    
                        ...
                        <?php 
                            include('../Control/conexion.php');
                            if(isset($_POST['act_repartidor'])){
                                $id = $_POST['id_new_repartidor'];
                                $nombre_ = $_POST['nombre_new_repartidor'];
                                $vehiculo_ = $_POST['vehiculo_new_repartidor'];
                                $telefono_ = $_POST['telefono_new_repartidor'];
                                $res = "CALL UPDATE_REPARTIDOR ($id,'$nombre_','$vehiculo_',$telefono_)";
                                if ($conn->query($res) === TRUE) {
                                    ?> <h3 class="mt-3 text-center bg-success">Repartidor actualizado exitosamente</h3> <?php
                                } else {
