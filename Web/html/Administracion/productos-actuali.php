        ...
        <div class="container">
            <div class="row p-5">
                ...
                <div class="col text-center">  
                    <form method="get">
                        <h5 class="">Ingrese el identificador del producto a actualizar</h5>
                        <div class="form-floating mb-3 mt-2">
                            <input type="number" name="id_act_producto" class="form-control" id="floatingInput" placeholder="Identificador">
                            <label for="floatingInput">Identificador</label>
                            <button type="submit" name="buscar_producto" class="mt-5 btn btn-dark bg-warning shadow text-dark">Buscar Producto</button>
                        </div>
                    </form>
                </div>
                <div class="col"></div>
                <table class="table table-striped ">
                    ...
                    <tbody>
                        ...
                        if(isset($_GET['buscar_producto'])){
                            if($_GET['id_act_producto'] !=''){
                                $_id = $_GET['id_act_producto'];
                                ...
                                while($row = mysqli_fetch_array(($resultado))){
                                    if($row['ID_PRODUCTO'] == $_id){?>
                                        <tr>
                                            ...
                                            <form action="/Administracion/productos-actuali.php" method="post">
                                                <td>
                                                    <div class="col-md-5">
                                                        <input type="number" name="id_new_producto" class="form-control " id="floatingInput" value="<?php echo $row['ID_PRODUCTO'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <input type="text" name="nombre_new_producto" class="form-control " id="floatingInput" value="<?php echo $row['NOMBRE'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <input type="text" name="precio_new_producto" class="form-control " id="floatingInput" value="<?php echo $row['PRECIO'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <input type="text" name="tiempo_new_producto" class="form-control " id="floatingInput" value="<?php echo $row['T_PREPARACION'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col-md-5">
                                                        <input type="number" name="id-cat_new_producto" class="form-control " id="floatingInput" value="<?php echo $row['ID_CATEGORIA'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <input type="text" name="categoria_new_producto" class="form-control " id="floatingInput" value="<?php echo $row['NOMBRE_CATEGORIA'];?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col">
                                                        <button type="submit" name="act_producto" class="btn btn-dark bg-warning shadow text-dark">Actualizar</button>
                                                    </div>
                                                </td>
                                            </form>
                                        </tr><?php    
                        ...
                        <?php 
                            include('../Control/conexion.php');
                            if(isset($_POST['act_producto'])){
                                $id = $_POST['id_new_producto'];
                                $nombre_ = $_POST['nombre_new_producto'];
                                $precio_ = $_POST['precio_new_producto'];
                                $tiempo_ = $_POST['tiempo_new_producto'];
                                $id_cat_ = $_POST['id-cat_new_producto'];
                                $res = "CALL UPDATE_PRODUCTO ($id, $id_cat_, '$nombre_', $precio_, $tiempo_)";
                                if ($conn->query($res) === TRUE) {
                                    ?> <h3 class="mt-3 text-center bg-success">Producto acturalizado exitosamente</h3> <?php
                                } else {
